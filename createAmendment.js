...
const selectedReview = async () => {
  ...
  sendAmendmentWrapper.innerHTML += '<label>PDF IPFS Hash</label><input class="pure-input-1" type="text" placeholder="Enter PDF IPFS Hash" id="amendment-pdf-ipfs-hash">' 
